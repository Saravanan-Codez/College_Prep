# EngiPrep Android Signed Build Script (Falkon Labs)
...
Write-Host "🚀 Building Falkon Labs Signed Android Release APK..." -ForegroundColor Green
npx tauri android build --apk
Write-Host "✅ Signed APK built successfully!" -ForegroundColor Green
