        ...
        <div style="max-width: 580px; margin: 0 auto; width: 100%; display: flex; flex-direction: column; gap: 20px;">
          ...
          {#if isFlashcardFlipped}
            <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 10px;">
              <button on:click={() => rateFlashcard(1)} aria-label="Rate Again, review in 1 day" class="btn" style="color: var(--accent-red); flex-direction: column; height: auto; padding: 10px 0; gap: 3px;">
              ...
              <button on:click={() => rateFlashcard(2)} aria-label="Rate Hard, review in 2 days" class="btn" style="color: var(--accent-amber); flex-direction: column; height: auto; padding: 10px 0; gap: 3px;">
              ...
              <button on:click={() => rateFlashcard(3)} aria-label="Rate Good, review in 4 days" class="btn" style="color: var(--accent-blue); flex-direction: column; height: auto; padding: 10px 0; gap: 3px;">
              ...
              <button on:click={() => rateFlashcard(4)} aria-label="Rate Easy, review in 7 days" class="btn" style="color: var(--accent-green); flex-direction: column; height: auto; padding: 10px 0; gap: 3px;">
